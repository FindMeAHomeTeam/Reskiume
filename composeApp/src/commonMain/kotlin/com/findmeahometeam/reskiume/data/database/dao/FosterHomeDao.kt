...
interface FosterHomeDao {
    ...
    suspend fun deleteAcceptedNonHumanAnimalEntityForFosterHome(acceptedNonHumanAnimalId: String): Int
    ...
    @Query("DELETE FROM FosterHomeEntity WHERE ownerId = :ownerId OR savedBy = :ownerId OR savedBy = ' ' OR savedBy = '' ")
