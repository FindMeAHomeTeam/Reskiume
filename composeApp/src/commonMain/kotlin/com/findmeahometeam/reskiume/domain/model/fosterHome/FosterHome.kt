...
data class FosterHome(
    ...
    val imageUrl: String,
    val allAcceptedNonHumanAnimalTypes: List<AcceptedNonHumanAnimalTypeForFosterHome>,
    val allAcceptedNonHumanAnimalGenders: List<AcceptedNonHumanAnimalGenderForFosterHome>,
    ...
    fun toData(): RemoteFosterHome {
        return RemoteFosterHome(
            ...
            conditions = conditions,
            imageUrl = imageUrl,
            allAcceptedNonHumanAnimalTypes = allAcceptedNonHumanAnimalTypes.map { it.toRemote() },
            allAcceptedNonHumanAnimalGenders = allAcceptedNonHumanAnimalGenders.map { it.toRemote() },
