...
class GetAllMyRescueEventsFromLocalRepository(private val localRescueEventRepository: LocalRescueEventRepository) {

    operator fun invoke(ownerId: String): Flow<List<RescueEvent>> =
        localRescueEventRepository.getAllMyRescueEvents(ownerId)
            .map { list ->
