...
class SubscribeToAllTopicsFromSubscriberRepository(private val repository: FCMSubscriberRepository) {

    suspend operator fun invoke(
        allSubscriptions: List<Subscription>
    ): Flow<Boolean> = repository.subscribeToAllTopics(allSubscriptions)
}
