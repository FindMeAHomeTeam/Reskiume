...
class GetAllMyNonHumanAnimalsFromLocalRepositoryTest: CoroutineTestDispatcher() {
    ...
    @Test
    fun `given local non human animals the user caregives_when the app retrieves them to list them_then app gets a flow of list of NonHumanAnimal`() =
        runTest {
