            ...
            if (isSuccess) {
                ...
                if (residentNonHumanAnimal == null) {
                    log.d(
                        ...
                        "updateAdoptionStates: Can not update the non human animal state for the non human animal in the foster home $fosterHomeId because the non human animal has been unregistered in the local data source"
                    )
                } else {
