...
import reskiume.shared.generated.resources.check_reviews_screen_user_profile_title
import reskiume.shared.generated.resources.check_reviews_screen_my_reviews_title
import reskiume.shared.generated.resources.check_reviews_screen_no_reviews
import reskiume.shared.generated.resources.check_reviews_screen_user_deleted
import reskiume.shared.generated.resources.check_reviews_screen_user_reviews_title
import reskiume.shared.generated.resources.reskiume

@Composable
fun CheckAllReviewsScreen(
    onBackPressed: () -> Unit,
    onReviewClick: (uid: String) -> Unit
) {

    val checkAllReviewsViewmodel: CheckAllReviewsViewmodel = koinViewModel<CheckAllReviewsViewmodel>()
    val reviewListState: UiState<List<UiReview>> by checkAllReviewsViewmodel.reviewListState.collectAsStateWithLifecycle()
    val user: User? by checkAllReviewsViewmodel.userDataIfNotMine.collectAsStateWithLifecycle()
    ...
    RmScaffold(
        ...
        Column(
            ...
            RmResultState(uiState = reviewListState) { reviewList ->
